...
public class MainActivity_DashboardWebViewClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PisonetManager.Android.MainActivity+DashboardWebViewClient, PisonetManager.Android", MainActivity_DashboardWebViewClient.class, __md_methods);
	}


	public MainActivity_DashboardWebViewClient ()
	{
		super ();
		if (getClass () == MainActivity_DashboardWebViewClient.class) {
			mono.android.TypeManager.Activate ("PisonetManager.Android.MainActivity+DashboardWebViewClient, PisonetManager.Android", "", this, new java.lang.Object[] {  });
		}
	}

	public MainActivity_DashboardWebViewClient (crc640779913324aae7e9.MainActivity p0)
	{
		super ();
		if (getClass () == MainActivity_DashboardWebViewClient.class) {
			mono.android.TypeManager.Activate ("PisonetManager.Android.MainActivity+DashboardWebViewClient, PisonetManager.Android", "PisonetManager.Android.MainActivity, PisonetManager.Android", this, new java.lang.Object[] { p0 });
		}
	}
